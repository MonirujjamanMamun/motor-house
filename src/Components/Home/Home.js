    ...
    return (
        <div className='flex justify-center items-center'>
            <div className=''>
                ...
                <h1 className='text-5xl text-blue-500 text-bold'>Your best Motor</h1>
                <p>Yamaha Motor Corporation, USA (YMUS), is a recognized leader in the outdoor recreation industry. </p>
            </div>
            <div>
